/*******************************************************************************
Conjugate Gradient Method for MINLIN library
Lukas Pospisil, 2016
...
#include "petscvector/petscvector.h"
#include "generalmatrix/laplacefullmatrix.h"
...
namespace threx {
	...
	VectorType cg(const GeneralMatrix<VectorType> &A, const VectorType &b, const VectorType &x0){
